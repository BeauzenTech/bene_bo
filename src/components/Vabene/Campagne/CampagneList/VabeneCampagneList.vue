      ...
      <div class="table-responsive">
        <table class="table text-nowrap align-middle mb-0">
          ...
          >
            ...
            <td class="shadow-none lh-1 fw-medium text-muted">
              {{  categorie.destination.length }} destinataire(s)
            </td>
            <td class="shadow-none lh-1 fw-medium text-muted">
          ...
          <tr v-else>
            <EmptyTable
                message="Aucune campagne pour le moment"
                :colspan="8"
...
import {ApiResponse, PaginatedCampagne, PaginatedCategorie} from "@/models/Apiresponse";
...
export default defineComponent({
  ...
  data(){
    return{
      ...
      originalCategories: [] as CampagneModel[], // Stockage des utilisateurs originaux
      categorieSelected: null,
    }
  },
  computed: {
    allCategorie(): CampagneModel[] {
