...
import {ApiResponse, PaginatedCategorie, PaginatedNotification} from "@/models/Apiresponse";
...
export default defineComponent({
  ...
  data(){
    return{
      categorieResponse: null as ApiResponse<PaginatedNotification> | null,
      isLoading: false,
      currentPage: 1 ,
      searchQuery: '', // Ajout du champ de recherche
      originalCategories: [] as NotificationModel[], // Stockage des utilisateurs originaux
      categorieSelected: null,
    }
  },
  computed: {
    allCategorie(): NotificationModel[] {
