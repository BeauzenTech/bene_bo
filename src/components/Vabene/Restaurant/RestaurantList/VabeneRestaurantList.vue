...
<!--            </th>-->
          ...
          >
            ...
            <td v-if="restaurant.userID" class="shadow-none lh-1 fw-medium text-black-emphasis">
              {{ restaurant.userID.first_name }}  {{ restaurant.userID.last_name }}
            </td>
            ...
            <td v-if="restaurant.codePostalID" class="shadow-none lh-1 fw-medium text-black-emphasis">
              {{ restaurant.codePostalID.numeroPostal || '-' }} - {{ restaurant.codePostalID.ville || '-' }}
            </td>
            <td v-else class="shadow-none lh-1 fw-medium text-black-emphasis">
              <span>-</span>
            </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" @click="confirmationDeleteAction(restaurantSelected)" data-bs-dismiss="modal">
