    ...
    <div class="sidebar-menu mt-30">
      ...
      >
        ...
        <li class="sub-title sidebar-nav-item">
          <span class="d-block text-uppercase fw-medium">Ventes</span>
        </li>
        <li
            ...
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/order-list" class="sidebar-sub-menu-link">
                    Commandes
                  </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
...
<!--         CRM -->
        <li class="sub-title sidebar-nav-item">
          <span class="d-block text-uppercase fw-medium">CRM</span>
        </li>
        <li
            class="sidebar-nav-item accordion-item bg-transparent border-0 rounded-0"
        >
...
<!--                <li class="sidebar-sub-menu-item">-->
<!--                  <router-link to="/ajout-franchise" class="sidebar-sub-menu-link">-->
<!--                    Ajouter-->
<!--                  </router-link>-->
<!--                </li>-->
