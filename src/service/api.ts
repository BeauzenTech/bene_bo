...
import {
  ...
  PaginatedProgramme,
  PaginatedRestaurant,
  PaginatedRestaurantCategory,
  PaginatedRestaurantProduct,
  PaginatedCategories,
  CategoriesApiResponse,
  CategoriesApiFullResponse,
  PaginatedUsers,
...
import {
  CreateIngredientBaseRequest,
  IngredientBaseModel,
  UpdateIngredientBaseRequest,
} from "@/models/ingredientBase.model";
  ...
  (error) => {
    ...
    if (error.response && error.response.status === 401) {
      ...
      return Promise.reject(
        new Error("Token expiré - Redirection vers la page de connexion")
      );
    }
...
// Fonction pour se connecter
export const resetPasswordStepOne = async (
  email
...
// Fonction pour se connecter
export const resetPasswordStepTwo = async (
  resetData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      "/user/reset_password/update",
      resetData
    );
    return response.data;
  } catch (error) {
...
export const updateUser = async (
  ...
  try {
    ...
    console.error(
      "Erreur lors de la mise à jour du compte utilisateur.",
      error
    );
    throw error;
  }
...
// Fonction pour mettre a jour un compte utilisateur
export const toggleActivationUser = async (
  userID: string,
  userData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/user/activate/${userID}`,
      userData
    );
    return response.data;
  } catch (error) {
    console.error(
      "Erreur lors du toggle activation du compte utilisateur.",
      error
    );
    throw error;
  }
...
export const fetchAllPostalCode = async (): Promise<ApiResponse<any>> => {
  try {
    ...
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.get(
      `/v1/delivery/restaurant/${restaurantId}/postal-codes`
    );
    return response.data;
  } catch (error) {
...
export const getUserAddresses = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.get(
      `/v1/user/adresseLocal/${userID}`
    );
    return response.data;
  } catch (error) {
    console.error(
      "Erreur lors de la récupération des adresses utilisateur",
      error
    );
    throw error;
  }
...
// FRANCHISE
export const listefranchises = async (
  page = 1
): Promise<ApiResponse<PaginatedFrachises>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/v1/franchise/filter/existing?page=${page}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const detailFranchise = async (
  franchiseID
): Promise<ApiResponse<FranchiseModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const updateFranchise = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/franchise/update/${franchiseID}`,
      franchiseData
    );
    return response.data;
  } catch (error) {
...
export const toggleActivationFranchise = async (
  franchiseID: string,
  franchiseData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/franchise/activate/${franchiseID}`,
      franchiseData
    );
    return response.data;
  } catch (error) {
...
export const deleteFranchise = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/franchise/delete/${franchiseID}`
    );
    return response.data;
  } catch (error) {
...
export const listeRestaurant = async (
  page = 1
): Promise<ApiResponse<PaginatedRestaurant>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/restaurant/filter/existing?page=${page}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const detailRestaurant = async (
  restaurantID
...
export const updateRestaurant = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/restaurant/update/${restaurantID}`,
      restaurantData
    );
    return response.data;
  } catch (error) {
...
// Fonction pour mettre a jour un compte utilisateur
export const toggleRestaurant = async (
  restaurantID: string,
  restaurantData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/restaurant/activate/${restaurantID}`,
      restaurantData
    );
    return response.data;
  } catch (error) {
...
export const deleteRestaurant = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/restaurant/delete/${restaurantID}`
    );
    return response.data;
  } catch (error) {
    console.error("Erreur lors de la suppression du compte", error);
...
export const listeOrder = async (
  ...
  try {
    ...
    const response = await apiClient.get(
      `/v1/restaurants/${id}/orders?${params.toString()}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const listeOrderByAdmin = async (
  ...
  try {
    ...
    const response = await apiClient.get(
      `/v1/restaurants/${restaurantID}/orders?${params.toString()}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const listeMethodePaiement = async (
  page = 1
): Promise<ApiResponse<PaginatedMethodePaiement>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/methode_paiement/filter/active?page=${page}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const listeOrderType = async (
  page = 1
): Promise<ApiResponse<PaginatedOrderType>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/orderType/filter/active?page=${page}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const allStatusPaiementOrder = async (): Promise<
  ApiResponse<string[]>
> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const detailPaiement = async (
  paymentID
...
): Promise<ApiResponse<PaginatedCategorie>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/category/filter/existing/${usePagination}?page=${page}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const getAllCategories = async (
  ...
  try {
    ...
    const result = new ApiResponse(response.data.code, response.data.message, {
...
export const addRestaurantCategorie = async (
  categorieID: string
): Promise<ApiResponse<any>> => {
  try {
    const restaurantID = localStorage.getItem(
    ...
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/restaurant/categorie/addcategorie_restaurant/${restaurantID}/${categorieID}`
    );
    return response.data;
  } catch (error) {
    console.error(
      "Erreur lors de l'ajout de restaurant de la categorie",
      error
    );
    throw error;
  }
...
export const listeRestaurantCategorie = async (
  ...
  try {
    ...
    const response = await apiClient.get(
      `/v1/category/all?page=${page}&limit=${limit}${searchParam}`
    );
    return response.data;
  } catch (error) {
    throw error;
...
export const toggleActivationCategorieRestaurant = async (
  categorieID: string
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/restaurant/categorie/toggle/${categorieID}`
    );
    return response.data;
  } catch (error) {
...
export const deleteRestaurantCategorie = async (
  restaurantCategorieID: string
): Promise<ApiResponse<void>> => {
  try {
    const restaurantID = localStorage.getItem(
      UserGeneralKey.USER_RESTAURANT_ID
    ...
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/restaurant/categorie/remove/${restaurantID}/${restaurantCategorieID}`
    );
    return response.data;
  } catch (error) {
...
export const listeRestaurantProduct = async (
  page = 1,
  usePagination: string,
  categoryId?: string
): Promise<ApiResponse<PaginatedRestaurantProduct>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const restaurantID = localStorage.getItem(
      UserGeneralKey.USER_RESTAURANT_ID
...
export const toggleActivationProductRestaurant = async (
  productID: string
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/restaurant/product/toggle/${productID}`
    );
    return response.data;
  } catch (error) {
...
export const listeCategorieActive = async (
  page = 1,
  usePagination: string
): Promise<ApiResponse<PaginatedCategorie>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/category/filter/active/${usePagination}?page=${page}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const detailCategorie = async (
  categorieID
): Promise<ApiResponse<CategorieModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(`/v1/category/${categorieID}`);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const updateCategorie = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/category/update/${categorieID}`,
      categorieData
    );
    return response.data;
  } catch (error) {
...
export const deleteCategorie = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/category/delete/temporary/${categorieID}`
    );
    return response.data;
  } catch (error) {
    console.error("Erreur lors de la suppression de la categorie", error);
...
// Fonction pour mettre a jour un compte utilisateur
export const toggleActivationCategorie = async (
  categorieID: string,
  categorieData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/category/activate/${categorieID}`,
      categorieData
    );
    return response.data;
  } catch (error) {
...
export const listeIngredient = async (
  page = 1,
  usePagination: string
): Promise<ApiResponse<PaginatedIngredient>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const detailIngredient = async (
  ingredientID
): Promise<ApiResponse<IngredientModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(`/v1/ingredient/${ingredientID}`);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const updateIngredient = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/add/ingredient/update/${ingredientID}`,
      ingredientData
    );
    return response.data;
  } catch (error) {
...
export const updateVariationIngredient = async (
  ingredientID,
  varationData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/add/ingredient/variation/update/${ingredientID}`,
      varationData
    );
    return response.data;
  } catch (error) {
    console.error(
      "Erreur lors de la mise a jour de la variation ingredient",
      error
    );
    throw error;
  }
...
export const deleteIngredientVariation = async (
  ingredientID: string,
  variationID: string
): Promise<ApiResponse<void>> => {
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/add/ingredient/variation/delete/${ingredientID}/${variationID}`
    );
    return response.data;
  } catch (error) {
    console.error(
      "Erreur lors de la suppression de variation ingredient",
      error
    );
    throw error;
  }
...
export const deleteIngredient = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/add/ingredient/delete/${ingredientID}`
    );
    return response.data;
  } catch (error) {
...
export const toggleActivationIngredient = async (
  ingredientID: string,
  ingredientData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/add/ingredient/activate/${ingredientID}`,
      ingredientData
    );
    return response.data;
  } catch (error) {
...
export const listeProducts = async (
  page = 1,
  usePagination: string,
  filter: string,
  filterData
): Promise<ApiResponse<PaginatedProduct>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.post(
      `/product/filter/${filter}/${usePagination}?page=${page}`,
      filterData
    );
    return new ApiResponse(
      response.data.code,
...
export const updateVariationProduct = async (
  productID,
  varationData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/product/variation/update/${productID}`,
      varationData
    );
    return response.data;
  } catch (error) {
    console.error(
      "Erreur lors de la mise a jour de la variation produit",
      error
    );
    throw error;
  }
...
export const removeVariationProduct = async (
  productID: string,
  variationID: string
): Promise<ApiResponse<void>> => {
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/product/variation/remove/${productID}/${variationID}`
    );
    return response.data;
  } catch (error) {
    console.error(
      "Erreur lors de la suppression de la variation du produit",
      error
    );
    throw error;
  }
...
export const toggleActivationProduct = async (
  productID: string,
  productData
): Promise<ApiResponse<any>> => {
  try {
...
export const toggleActivationFeatureProduct = async (
  productID: string,
  productData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/product/state/toggle/${productID}`,
      productData
    );
    return response.data;
  } catch (error) {
...
export const deleteProductTemporary = async (
  productID: string
): Promise<ApiResponse<void>> => {
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/product/delete/temporary/${productID}`
    );
    return response.data;
  } catch (error) {
    console.error("Erreur lors de la suppression ingredient", error);
...
export const reportVenteAdmin = async (
  restaurantID?: string
): Promise<ApiResponse<SellModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const url = [`/statistics/restaurant`, restaurantID]
...
export const reportVenteRestaurant = async (
  restaurantID?: string
): Promise<ApiResponse<SellModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const reportRestaurants = async (
  restaurantID?: string
): Promise<ApiResponse<SellModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const salesReportRestaurants = async (): Promise<
  ApiResponse<SellModel>
> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const reportPeriodiqueCardById = async (
  restaurantID: string
): Promise<ApiResponse<PeriodiqueCardReport>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/initial/order/periodique_report/${restaurantID}`
    );
    return response.data;
  } catch (error) {
    throw error;
...
export const listeCampagne = async (
  page = 1,
  limit = 10,
  search = ""
): Promise<ApiResponse<PaginatedCampagne>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const params = new URLSearchParams();
    if (page) params.append("page", page.toString());
...
export const detailCampagne = async (
  campgneID
): Promise<ApiResponse<CampagneModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const listeNotification = async (
  page = 1,
  limit = 10,
  search = "",
  status = ""
): Promise<ApiResponse<PaginatedNotification>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const params = new URLSearchParams();
    if (page) params.append("page", page.toString());
    ...
    const response = await apiClient.get(
      `/v1/push-notifications?${params.toString()}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const disableCoupon = async (
  code,
  couponData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
      `/v1/coupon/order/disable/${code}`,
      couponData
    );
    return response.data;
  } catch (error) {
...
export const detailCoupon = async (
  couponID
): Promise<ApiResponse<CouponModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const listeCoupon = async (
  page = 1
): Promise<ApiResponse<PaginatedCoupon>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const listeProgramme = async (
  page = 1
): Promise<ApiResponse<PaginatedProgramme>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const detailProgramme = async (
  programmeID
): Promise<ApiResponse<ProgrammeModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
...
export const toggleActivationProgramme = async (
  programmeData
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.put(
...
export const detailNotification = async (
  notificationID
): Promise<ApiResponse<NotificationModel>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const response = await apiClient.get(
      `/v1/push-notifications/${notificationID}`
    );
    return response.data;
  } catch (error) {
    throw error;
...
export const detailCustomer = async (
  customerID
...
export const topProductReportSell = async (
  categoryID,
  restaurantID
): Promise<ApiResponse<TopProductSellModel[]>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const url = [`/v1/report_sale/products`, categoryID, restaurantID]
      .filter(Boolean) // retire les undefined
      .join("/");
    const response = await apiClient.get(url);
    return new ApiResponse(
...
export const averageReportSell = async (
  productID: string,
  restaurantID?: string
): Promise<ApiResponse<AverageReportModel[]>> => {
  // eslint-disable-next-line no-useless-catch
  try {
    const url = [`/v1/report_sale/average/${productID}`, restaurantID]
      .filter(Boolean) // retire les undefined
      .join("/");
    const response = await apiClient.get(url);
    return new ApiResponse(
...
export const uploadFile = async (file: File): Promise<ApiResponse<any>> => {
  try {
    ...
    const response: AxiosResponse<ApiResponse<any>> =
      await apiClientFormData.post("/v1/upload", formData);
    return response.data;
  } catch (error) {
...
export const deleteFileUpload = async (
  ...
  try {
    const response: AxiosResponse<ApiResponse<void>> = await apiClient.delete(
      `/v1/upload/delete/${public_idData}`
    );
    return response.data;
  } catch (error) {
...
export const calculateMinimumAmount = async (
  codePostal: string,
  localite: string,
  restaurantId: string
): Promise<ApiResponse<any>> => {
  try {
    const response: AxiosResponse<ApiResponse<any>> = await apiClient.get(
      `/v1/zone/calculate-minimum-amount?codePostal=${codePostal}&localite=${localite}&restaurantId=${restaurantId}`
    );
    return response.data;
  } catch (error) {
...
export const getDeliveryZonesByRestaurant = async (
  ...
  try {
    const response = await apiClient.get(
      `/v1/delivery/restaurant/${restaurantId}/zones`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const getDeliveryZoneById = async (
  ...
  try {
    ...
    console.error(
      "❌ Erreur lors de la récupération de la zone de livraison",
      error
    );
    throw error;
  }
...
export const createDeliveryZone = async (
  ...
  try {
    ...
    console.error(
      "❌ Erreur lors de la création de la zone de livraison",
      error
    );
    throw error;
  }
...
export const updateDeliveryZone = async (
  ...
  try {
    ...
    console.error(
      "❌ Erreur lors de la mise à jour de la zone de livraison",
      error
    );
    throw error;
  }
...
export const deleteDeliveryZone = async (
  ...
  try {
    ...
    console.error(
      "❌ Erreur lors de la suppression de la zone de livraison",
      error
    );
    throw error;
  }
...
export const addPostalCodesToZone = async (
  ...
  try {
    const response = await apiClient.post(
      `/v1/delivery/zone/${zoneId}/postal-codes`,
      postalCodes
    );
    return new ApiResponse(
      response.data.code,
...
export const deletePostalCodeFromZone = async (
  ...
  try {
    const response = await apiClient.delete(
      `/v1/delivery/zone/${zoneId}/postal-codes/${postalCode}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const getRestaurantPostalCodes = async (
  ...
  try {
    ...
    console.error(
      "❌ Erreur lors de la récupération des codes postaux du restaurant",
      error
    );
    throw error;
  }
...
export const getOpeningDaysByRestaurant = async (
  ...
  try {
    const response = await apiClient.get(
      `/v1/opening-days/restaurant/${restaurantId}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
    ...
    console.error(
      "❌ Erreur lors de la récupération des jours d'ouverture",
      error
    );
    throw error;
  }
...
export const deleteOpeningDay = async (
  ...
  try {
    ...
    console.error(
      "❌ Erreur lors de la suppression du jour d'ouverture",
      error
    );
    throw error;
  }
...
export const getOpeningHoursByRestaurant = async (
  ...
  try {
    const response = await apiClient.get(
      `/v1/opening-hours/restaurant/${restaurantId}/formatted`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
...
export const getDetailedOpeningHours = async (
  ...
  try {
    const response = await apiClient.get(
      `/v1/opening-hours/restaurant/${restaurantId}`
    );
    return new ApiResponse(
      response.data.code,
      response.data.message,
    ...
    console.error(
      "❌ Erreur lors de la récupération des horaires détaillés",
      error
    );
    throw error;
  }
