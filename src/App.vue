                  ...
                  <div class="receipts" id="recu-pdf">
                    <div class="receipt">
                      <div class="logo-container">
                        <img
                          src="https://res.cloudinary.com/dmxs8btps/image/upload/v1755765444/ttpjntx3u2xloclzd61t.png"
                          class="airliner-logo"
                          width="150px"
                        />
                      </div>
                      <div class="route">
                        <h2>
                          <strong
                            >Livraison de pizzas
                            {{ orderResponse.restaurantID.name }}</strong
                          >
                        </h2>
                        <h2>
                          <strong>{{
                        ...
                        <h2>
                          <strong>{{ orderResponse.restaurantID.taxe }}</strong>
                        </h2>
                      </div>
                      <span style="margin: 1rem 0; width: 100%; color: #000"
                        >------------------------------------------------------------------------</span
                      >
                      ...
                      <div class="route">
                        ...
                        <h2>
                          <strong
                            >{{ orderResponse.npa ?? "" }}
                            {{ orderResponse.localite ?? "" }}</strong
                          >
                        </h2>
                        <h2>
                          <strong
                            >{{ orderResponse.rue }} -
                            {{ orderResponse.numberRue }}</strong
                          >
                        </h2>
                        <h2>
                          <strong>{{
                      ...
                      <div class="route">
                        ...
                        >
                          <strong>{{ orderTypeSelected[0].libelle }}</strong>
                        </h2>
                        <h2>
                          <strong>{{
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                <strong
                                  >x{{ ingredient.quantite }}
                                  {{ ingredient.name }} ({{
                                    ingredient.extra_cost_price *
                                      ingredient.quantite +
                                    " CHF"
                                  }})</strong
                                >
                      ...
                      <div class="product-list">
                        <div
                          ...
                          "
                        >
                          <span style="flex: 1; margin-right: 3px"
                          ...
                          <span style="flex: 0 0 auto; text-align: right"
                            ><strong
                              >{{
                                ...
                                getDiscountValue(orderResponse)
                              }}
                              CHF</strong
                            ></span
                          >
                        ...
                        <div
                          style="
                            ...
                            margin: 5px 0;
                          "
                          v-if="orderResponse.discountValue != ''"
                        >
                          <span style="flex: 1; margin-right: 3px"
                            ><strong>RABAIS: </strong></span
                          >
                          <span
                            ...
                            ></span
                          >
                          <span style="flex: 0 0 auto; text-align: right" v-else
                            ><strong>0 CHF</strong></span
                          >
                        </div>
                        <div
                          style="
                        ...
                        >
                          <span style="flex: 1; margin-right: 3px"
                            ><strong>Y COMPRIS TVA (2.60%)</strong></span
                          >
                          <span style="flex: 0 0 auto; text-align: right"
                            ><strong
                              >{{
                                (
                                  (orderResponse.total_price * 2.6) /
                                  100
                                ).toFixed(2)
                              }}
                              CHF</strong
                        ...
                        >
                          <span style="flex: 1; margin-right: 5px"
                            ><strong>FRAIS SUPPLÉMENTAIRES: </strong></span
                          >
                          <span
                            style="flex-shrink: 0; text-align: right"
                            v-if="orderResponse.restMinimumOrder != ''"
                            ><strong
                              >{{
                                orderResponse.restMinimumOrder ?? "-"
                              }}
                              CHF</strong
                            ></span
                          >
                          <span style="flex-shrink: 0; text-align: right" v-else
                            ><strong>0 CHF</strong></span
                          >
                        </div>
                        <div
                        ...
                        >
                          ...
                          <span style="flex: 0 0 auto; text-align: right"
                            ><strong
                              >{{ orderResponse.total_price }} CHF</strong
                            ></span
                          >
                        </div>
                        <div
                        ...
                        >
                          ...
                          <span
                            style="flex: 1; text-align: right; line-height: 1.1"
                            >{{ methodePaiementSelected[0].libelle }}</span
                          >
                        </div>
                      </div>
                      <span style="margin: 1rem 0; width: 100%; color: #000"
    ...
    getDiscountValue(order: OrderModel): number {
      ...
      if (order.discountValue !== "" && order.discountType == "fixed") {
        ...
        discountValue =
          ...
          Number(order.total_price) * (Number(order.discountValue) / 100);
      }
...
#recu-pdf .airliner-logo {
  width: 120%;
    ...
    `;
        ...
        setTimeout(() => {
          const contentHeight =
            this.getHeightTicket() +
            (this.orderResponse?.orderItems.length ?? 1) * 5;
          const desiredHeight = Math.max(
            this.getHeightTicket(),
            contentHeight + 35
          ); // Minimum 200mm, ou hauteur du contenu + un peu de marge
          ...
          const opt = {
            ...
            jsPDF: {
              unit: "mm",
              format: [80, desiredHeight],
              orientation: "portrait",
            }, // <-- Exemple pour 80mm de papier
          };
    ...
    getHeightTicket(): number {
      return (
        225 +
        (this.orderResponse?.SpecialInstructions != null ? 15 : 0) +
        this.getHeightTicketWithIngredients()
      );
    },
    getHeightTicketWithIngredients(): number {
      let baseHeight = 0;
      if (
        this.orderResponse?.orderItems &&
        this.orderResponse.orderItems.length > 0
      ) {
